...
<div align="center">
<h1>Onion Architecture (Sogan Mimarisi)<h1>
...
<h2>Application<h2>
<p>Application katmanı içerisinde Domain katmanında bulunan entity nesnelerinin CRUD işlemlerinin imzasının (Interface) tutulduğu katmandır. Burada amaç gevşek bağlı (Loose Coupling) bir sistem oluşturmaktır.</p>
